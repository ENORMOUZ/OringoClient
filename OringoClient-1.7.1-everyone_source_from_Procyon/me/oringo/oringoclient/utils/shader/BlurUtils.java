...
public class BlurUtils
{
    ...
    public static void drawTexturedRectNoBlend(final float x, final float y, final float width, final float height, final float uMin, final float uMax, final float vMin, final float vMax, final int filter) {
        ...
        worldrenderer.pos((double)x, (double)(y + height), 0.0).func_181673_a((double)uMin, (double)vMax).endVertex();
        worldrenderer.pos((double)(x + width), (double)(y + height), 0.0).func_181673_a((double)uMax, (double)vMax).endVertex();
        worldrenderer.pos((double)(x + width), (double)y, 0.0).func_181673_a((double)uMax, (double)vMin).endVertex();
        worldrenderer.pos((double)x, (double)y, 0.0).func_181673_a((double)uMin, (double)vMin).endVertex();
        tessellator.draw();
