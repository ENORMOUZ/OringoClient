...
{
    public static void outlineESP(final EntityLivingBase entity, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final ModelBase modelBase, final Color color) {
        ...
        setColor(color);
        renderOne(2.0f);
        modelBase.render((Entity)entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scaleFactor);
        setColor(color);
        renderTwo();
        modelBase.render((Entity)entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scaleFactor);
        setColor(color);
    ...
    public static void outlineESP(final RenderLayersEvent event, final Color color) {
        ...
        setColor(color);
        renderOne(3.0f);
        event.modelBase.render((Entity)event.entity, event.limbSwing, event.limbSwingAmount, event.ageInTicks, event.netHeadYaw, event.headPitch, event.scaleFactor);
        setColor(color);
        renderTwo();
        event.modelBase.render((Entity)event.entity, event.limbSwing, event.limbSwingAmount, event.ageInTicks, event.netHeadYaw, event.headPitch, event.scaleFactor);
        setColor(color);
